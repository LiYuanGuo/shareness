...
<script src="../static/js/upload/siteupload.js"></script> 
</head>
<body>
	<div class="admin-content">
  <input type="hidden" value="auditing_edit.html" id="filename">
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">景点信息</strong> / <small>景点展示</small></div>
  </div>
    ...
    <div class="am-form am-u-sm-12">
        <fieldset>
          ...
          <div class="am-g am-form-group ">
            <label for="r_name" class="am-u-sm-4 am-u-md-2 am-text-center">景点名称：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <input type="text" class="am-input-sm" id="name" placeholder="景点名称"  data-foolish-msg="最少四个字符!" required >
            </div>
          </div>
          <div class="am-g am-margin-top am-form-group">
            <label for="alias" class="am-u-sm-4 am-u-md-2 am-text-center">景点简介：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <textarea rows="3" cols="30" class="am-input-sm" id="briefContent" placeholder="景点简介" ></textarea>
            </div>
          </div>
          
          <div class="am-g am-margin-top am-form-group">
            <label for="address" class="am-u-sm-4 am-u-md-2 am-text-center">景点详细简绍：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
          
              <textarea rows="4" cols="30" class="am-input-sm" id="detailContent" placeholder="景点详细简绍"></textarea>
            </div>
          </div>
          
          <div class="am-g am-margin-top am-form-group">
            <label for="address" class="am-u-sm-4 am-u-md-2 am-text-center">景点门票：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <input type="text" class="am-input-sm" id="ticket" placeholder="景点门票">
            </div>
          </div>
          <div class="am-g am-margin-top am-form-group">
            <label for="address" class="am-u-sm-4 am-u-md-2 am-text-center">景点地址：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <input type="text" class="am-input-sm" id="address" placeholder="景点地址">
            </div>
          </div>
          <div class="am-g am-margin-top am-form-group">
          ...
          <div class="am-g am-margin-top am-form-group">
            <label for="phone" class="am-u-sm-4 am-u-md-2 am-text-center">景点路线：</label>
            <div class="am-u-sm-8  am-u-md-8 am-u-end">
              <textarea rows="3" cols="30" class="am-input-sm" id="route" placeholder="景点路线"></textarea>
            </div>
          </div>
          <div class="am-g am-margin-top am-form-group am-form-icon am-form-feedback">
            <label for="business_hours" class="am-u-sm-4 am-u-md-2 am-text-center">游玩方式：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <textarea rows="3" cols="30" class="am-input-sm" id="playMode" placeholder="游玩方式"></textarea>
            </div>
          </div>
          <div class="am-g am-margin-top am-form-group am-form-icon am-form-feedback">
          ...
          <div class="am-g am-margin-top am-form-group am-form-icon am-form-feedback">
            <label for="business_hours" class="am-u-sm-4 am-u-md-2 am-text-center">食宿：</label>
            <div class="am-u-sm-8 am-u-md-8 am-u-end">
              <textarea rows="3" cols="30" class="am-input-sm" id="shisu" placeholder="食宿"></textarea>
            </div>
          </div>
            
          <div class="am-g am-margin-top am-form-group">
            <label for="license" class="am-u-sm-4 am-u-md-2 am-text-center">景点图片：</label>
